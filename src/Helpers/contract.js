...
export const contractAddress = '0x6777eccdd48f9bfb4838a3941f3f3167cabfaa0c';//上架合約網址
...
export const signMessage_PC = async () => {
	return new Promise(async (resolve,reject)=>{
		try {
			...
			// const hexMessage = ethers.utils.hexlify(ethers.utils.toUtf8Bytes("Wallet0331"))

			// //------Test signMessage
			// const signature = await signer.signMessage(hexMessage);

			const data = ethers.utils.toUtf8Bytes('Wallet0331');
			const signer = provider.getSigner();
